public class TestEgalite{
	...
	private static boolean tousDifferents(int nombre1, int nombre2, int nombre3){
		return nombre1 != nombre2 && nombre2 != nombre3 && nombre3 != nombre1;
	}
	...
	private static boolean auPlusUneEgalite(int nombre1, int nombre2, int nombre3){
		return tousDifferents(nombre1, nombre2, nombre3) || (nombre1 == nombre2 && nombre2 != nombre3) || (nombre1 == nombre3 && nombre3 != nombre2) ||
				(nombre2 == nombre3 && nombre1 != nombre3);
	}

	private static boolean uneSeuleEgalite(int nombre1, int nombre2, int nombre3){
		if (tousEgaux(nombre1, nombre2, nombre3) || tousDifferents(nombre1,nombre2,nombre3))
			return false;
		return true;
	}
