public class TestDivisibilite{
    ...
    private static boolean unDesNombresEstLeResteDeLaDivisionDesDeuxAutres(int nombre1, int nombre2, int nombre3){
   	    return estLeResteDeLaDivision(nombre1, nombre2, nombre3) || estLeResteDeLaDivision(nombre1, nombre3, nombre2) ||
                estLeResteDeLaDivision(nombre2, nombre1, nombre3) || estLeResteDeLaDivision(nombre2, nombre3, nombre1) ||
                estLeResteDeLaDivision(nombre3, nombre1, nombre2) || estLeResteDeLaDivision(nombre3, nombre2, nombre1);  // A MODIFIER
   	}
