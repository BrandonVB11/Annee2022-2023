...
public class CabinesDEssayage {
	...
	public CabinesDEssayage(int nombreCabines){
		...
		// TODO
		this.tableOccupations = new boolean[nombreCabines];
		this.pileNumerosCabinesLibres = new PileImpl<>();
	...
	public int attribuerCabineLibre(){
		...
		int numero = pileNumerosCabinesLibres.pop();
		tableOccupations[numero-1] = true;
		return numero;
	}
